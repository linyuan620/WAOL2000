...
public class FlowPListAdapter extends BaseAdapter {
    ...
    public FlowPListAdapter(Context context, List<FlowInfo> d) {
        datas = d;
        mContext = context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(R.layout.flow_p_list_item, parent, false);
        }
        if (convertView != null) {

            TextView flowName = (TextView) convertView.findViewById(R.id.flow_p_name);
